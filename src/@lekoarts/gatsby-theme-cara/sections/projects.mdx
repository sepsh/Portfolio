...
![wow such empty](wow_such_empty.png)

<ProjectCard
  title="FastApi Docs Helper"
  link="https://github.com/sepsh/fastapi_docs_helper"
  bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
>
  A Firefox/Chromium extension which helps you read FastApi docs a bit easier.
</ProjectCard>
{/* <ProjectCard
